		...
		<div class="grid single-col span10">
			...
			<div class="grid-item threecol-one view view-second">
				<a href="<?php echo site_url(); ?>/services/wealth-creation/">
					...
					<div class="content">
						<h2>Wealth Creation</h2>  
						<p>Building a healthy retirement fund is essential to the long term financial strategy of our clients.</p>
			...
			<div class="grid-item threecol-one view view-second">
				<a href="<?php echo site_url(); ?>/services/business-consulting/">
					...
					<div class="mask" style="background-color:rgba(168,149,171, 0.9);"></div>
					<div class="content">
						<h2>Business Consulting</h2>  
			...
			<div class="grid-item threecol-one view view-second">
				<a href="<?php echo site_url(); ?>/services/asset-protection/">
					...
					<div class="content">
						<h2>Asset Protection</h2>  
						<p>At Peterson Group, we look at ways to protect your wealth and keep your prized portfolio safe.</p>
			...
			<div class="grid-item threecol-one last view view-second">
				<a href="<?php echo site_url(); ?>/services/self-managed-super-funds/">
					...
					<div class="mask" style="background-color: rgba(32,61,96, 0.9);"></div>
					<div class="content">
						<h2>Self Managed Super</h2>  
...
<div class="section bg-white" id="contact">
	<div class="col-full">
		...
		<div class="twocol-one">
			<p class="text-large text-black"><span class="text-light">Let's talk.</span><br />(03) 9380 3500</p>
			...
			<div class="threecol-two text-small">
				...
				<p><span class="text-caps text-black">Email</span><br /><a href="mailto:info@petersongroup.com.au">info@petersongroup.com.au</a></p>
				...
				<p><span class="text-caps text-black">Address</span><br /><a href="http://goo.gl/maps/xIDqr" target="_blank">First Floor, 4/35 Hope Street<br />Brunswick VIC 3056</a></p>
			</div>
			<div class="threecol-one text-small last">
				<a href="http://www.linkedin.com/company/3285242?trk=prof-exp-company-name" target="_blank">
					<div class="contact-icon"><span class="icon-stack"><i class="icon-circle icon-2x icon-stack-base"></i><i class="icon-linkedin icon-2x icon-light"></i></span></div>
					<p><span class="text-caps text-black">LinkedIn</span></p>
					<div class="clear"></div>
				</a>
				<a href="https://twitter.com/peterson_group" target="_blank">
					...
					<p><span class="text-caps text-black">Twitter</span></p>
					<div class="clear"></div>
				</a>
				<a href="https://www.facebook.com/Petersongroupmelb" target="_blank">
					...
					<p><span class="text-caps text-black">Facebook</span></p>
					<div class="clear"></div>
				</a>
			</div>
		</div>
		<div class="twocol-one last center"><img class="" src="<?php echo site_url(); ?>/wp-content/uploads/Peterson-Group-Map-Location-Address.jpg"></div>
	</div>
</div>
